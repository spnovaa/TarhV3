...
<div class="root-app" id="app">
    <div class="login-wrapper">
        <distributor-header-component></distributor-header-component>
        ...
        <div id="carouselExampleIndicators" class=" carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100 login100-more" src="../images/welcome/bg-02.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 login100-more" src="../images/welcome/bg-02.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 login100-more" src="../images/welcome/bg-02.jpg" alt="Third slide">
                </div>
            </div>
