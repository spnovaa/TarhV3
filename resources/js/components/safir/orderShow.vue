                ...
                <v-simple-table v-if="order">
                    <template v-slot:default>
                        ...
                        >
                            ...
                            <td class="text-right">
                                <v-text-field v-model.number="order[index].accept_sum" dense
        ...
        methods: {
            calcSum() {
                ...
                for (const item of this.order) {
                    ...
                    this.ordersSum = this.ordersSum + item.fee * item.accept_sum
                }
                this.ordersSum = this.ordersSum + this.porterage;
            },

            getOrder() {
                axios.post('/getOrder', {"transition_number": this.id})
                    .then((data) => {
                        if (data.data) {
                            ...
                            if (data.data[0].safir_confirm == 1) {
            ...
            confirm() {
                // this.disabled=true
                axios.post('/confirmOrders', this.form)
                    .then((data) => {
