                                    ...
                                    <v-row>
                                        ...
                                        <v-col class="py-1" cols="12" md="6">
                                            <v-text-field v-model="resume.national_id.val"
                                                          :class="{err : resume.national_id.err}" :rules="[rules.required]"
                                                          dense
                                        ...
                                        <v-col class="py-1" cols="12" md="6">
                                            <v-text-field v-model="resume.shop_surface.val" dense hint="اختیاری"
                                        ...
                                        <v-col class="py-1" cols="12">
                                            <v-row>
                                                <v-text-field v-model="resume.credit_card.val"
                                                              ...
                                                              dense
                                                              label="شماره کارت"
                                                              outlined @change="normalCreditCard"></v-text-field>
                                                <h1>
                            ...
                            <v-card-text>
                                <v-row>
                                    ...
                                    <v-col class="py-0" cols="12">
                                        <v-text-field v-model="resume.shop_tel.val" dense label="شماره فروشگاه"
                                    ...
                                    <v-col class="py-0" cols="12" md="6">
                                        <v-text-field v-model="resume.shop_zip.val"
                                                      :class="{err : resume.shop_zip.err}" :rules="[rules.required]"
                                                      dense
                                                      label="کدپستی" outlined
                                                      prepend-icon="mdi-traffic-light">
                                        </v-text-field>
                                    </v-col>
                                </v-row>
    ...
    data() {
        return {
            ...
            resume: {
                ...
                shop_tel: {val: '', req: 'required', err: false},
                shopName: {val: '', req: 'required', err: false},
                shop_surface: {val: '', req: 'optional', err: false},
                national_id: {val: '', req: 'required', err: false},
                shabaID: {val: '', req: 'required', err: false},
                credit_card: {val: '', req: 'required', err: false},
                ...
                shop_zip: {val: '', req: 'required', err: false},
            },
            baseInfo: {
                user_id: '',
                name: '',
    ...
    methods: {
        ...
        Register() {
            ...
            if (!this.error) {
                ...
                axios.post('shop/sendShopProfile', fd, {headers: {'Content-Type': 'multipart/form-data'}}).then((response) => {
                    this.success = true;
        ...
        normalShaba() {
            ...
            // this.normalShabaStr=this.resume.shabaID.val.split(' ').join('').split('-').join('');

            this.resume.shabaID.val = this.normalShabaStr;
        },
        normalCreditCard() {
            this.resume.credit_card.val = this.resume.credit_card.val.replace(/[^0-9]/g, '');
        }
    },
