<template>
    <v-container class="ma-1 grey lighten-2 pa-1" fluid>
                ...
                <v-row>
                    ...
                    <v-col cols="8">
                        <h5 style=" line-height:26pt">
                            لطفا پس از افزودن کتاب جدید، جهت اعمال تغییرات برروی
                            <span class="red--text">ذخیره تغییرات</span>
                            کلیک کنید. در غیر اینصورت تغییرات مورد نظر در سامانه اعمال نمیشود.
                        </h5>
        ...
        <v-card v-if="add_settings"  class="mt-n1"
            ...
            <v-card-text align="right">
                <v-dialog v-model="dialog" max-width="500px">
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn v-bind="attrs" v-on="on" class="mb-2" color="primary" dark>
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" md="4" sm="6">
                                        <v-text-field v-model="editedItem.fee" label="قیمت به تومان"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" md="4" sm="6">
                                    ...
                                    <v-col cols="12" md="4" sm="6">
                                        <v-text-field v-model="editedItem.shop_lib" :disabled="editedIndex > -1"
                                                      label="موجودی اولیه"
                ...
                <template>
                    <v-btn v-if="add_settings" class="mb-2 mr-2" color="success" dark @click.prevent="updateBooks">
...
<script>
    export default {
        data: () => ({
            ...
            add_settings:'',
            headers: [
                {text: 'نام کتاب', align: 'start', value: 'book_name' , color:'#C2185B'},
        ...
        methods: {
            ...
            getSettings(){
                axios.post('/shop/getShopAddNewBookSettings')
                    .then((data) => {
                        this.add_settings = data.data;
                        console.log(this.add_settings)
                    })
                    .catch(() => {
                        alert('خطا در ارتباط با سرور')
                    });
            ...
            save() {
                if (this.editedIndex > -1) {
                    ...
                    this.ErrMsg = 'تغییرات با موفقیت اعمال شد!'
                    this.success = true
            ...
            updateBooks() {
                ...
                axios.post('/shop/updateBooksList', fd)
                    .then((data) => {
