                ...
                <v-card-text>
                    <v-container>
                        ...
                        <v-row align="center" justify="center">
                            ...
                            <v-col cols="12" md="5" sm="5">
                                <v-text-field v-model="shopName" :rules="[rules.required]" label="نام فروشگاه" name="shop_name"
                                              required reverse></v-text-field>
                            </v-col>
...
export default {
    ...
    methods: {
        ...
        validate() {
            if (!this.name || !this.last_name || !this.shopName || !this.tel || !this.password || !this.password_check) {
                this.error = true;
                return null;
            }
