                ...
                <v-row>
                    ...
                    <v-col cols="8">
                        <h4 style=" line-height:26pt;color:#FFB300">
                            عملیات مربوط به این حساب کاربری:
                        </h4>
                        ...
                        <div v-if="showReturnOption">
                            <v-row class="pl-3">
                                ...
                                <v-spacer></v-spacer>
                                <v-btn class="success mt-6" to="../allResumes"> بازگشت به لیست</v-btn>
                            </v-row>
            ...
            <v-card class="px-5 my-7 boxborder">
                ...
                <v-card-text>
                    <v-col>
                        <v-row>
                            <v-col cols="5" md="3">
                                <v-text-field v-model="profile.name" dense disabled label="نام" outlined></v-text-field>
                            </v-col>
                            ...
                            <v-row>
                                ...
                                <v-col class="py-0" cols="6">
                                    <v-text-field v-model="profile.living_alley" dense disabled
                                                  label="کوچه" outlined prepend-icon="mdi-deviantart">
                                    </v-text-field>
                                </v-col>
                                <v-col class="py-0" cols="6">
                            ...
                            <v-row>
                                <v-col class="py-0" cols="12">
                                    ...
                                    <v-select v-model="profile.selling_background" :items="sellingYears"
                                              dense
                                              disabled item-text="time" item-value="code"
                                ...
                                <v-col class="py-0" cols="12">
                                    ...
                                    <v-textarea v-model="profile.book_background" class="mt-3" disabled hint="اختیاری"
                                ...
                                <v-col class="py-0" cols="12">
                                    ...
                                    <v-textarea v-model="profile.last_read_3b" class="mt-3" disabled hint="اختیاری" no-resize
                                                outlined persistent-hint rows="3"></v-textarea>
                                </v-col>
                                <v-col class="py-0" cols="12">
                                    <h6 style="text-align:right">
                            ...
                            <v-row>
                                <v-col class="py-0" cols="12">
                                    <v-text-field v-model="profile.moarref"
                                                  ...
                                                  label="معرف شما جهت شرکت در طرح" outlined persistent-hint></v-text-field>
                                </v-col>
                                <v-col class="py-0" cols="12">
                                    <v-text-field v-model="profile.payamresan"
                                                  dense disabled
                                                  hint="اختیاری"
                                                  label="در کدام پیامرسان فعالیت دارید؟" outlined persistent-hint></v-text-field>
                                </v-col>
                                ...
                                <v-col class="py-0" cols="12" md="6">
                                    <v-text-field v-model="profile.instagram"
                                                  dense disabled hint="اختیاری"
                                                  label="شناسه اینستاگرام" outlined persistent-hint></v-text-field>
                                </v-col>
                            </v-row>
                        </v-card-text>
                    </v-card>
...
<script>
    export default {
        ...
        methods: {
            getResume() {
                axios.post('/admin/getResume', {"id": this.id})
                    .then((data) => {
                        if (data.data) {
            ...
            saveResult() {
                if (this.result != 0) {
                    ...
                    axios.post('/admin/resumeVote', this.adminVote)
                        .then((data) => {
