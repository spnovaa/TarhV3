                ...
                <v-card-text style="text-align:right;">
                    <v-row>
                        ...
                        " value="4"></v-radio>
                            ...
                            <v-btn v-if="!showReturnOption" :disabled="!resultButton" class="red" @click="saveResult">
                                ثبت
                                نتیجه
                            </v-btn>
                                    ...
                                    <v-row>
                                        ...
                                        <v-col cols="12" md="6">
                                            <v-avatar class="ml-4" size="96">
                                                <img :src="'./images/distributors/'+profile.profile_image" alt="Avatar">
                                            </v-avatar>
                                        </v-col>
                                        <v-col cols="12" md="6">
                        ...
                        <v-card class="pa-8 boxborder">
                            ...
                            <v-card-text>
                                <v-row>
                                    ...
                                    <v-col class="py-0" cols="12">
                                        <v-text-field v-model="profile.company_tel" dense disabled label="تلفن"
                                    ...
                                    <v-col class="py-0" cols="12" md="6">
                                        <v-text-field v-model="profile.company_zip" dense disabled label="کدپستی"
                                                      outlined prepend-icon="mdi-traffic-light">
                                        </v-text-field>
                                    </v-col>
                                </v-row>
...
export default {
    ...
    methods: {
        getResume() {
            axios.post('/admin/getDistResume', {"id": this.id})
                .then((data) => {
                    if (data.data) {
        ...
        saveResult() {
            if (this.result != 0) {
                ...
                axios.post('/admin/distResumeVote', this.adminVote)
                    .then((data) => {
